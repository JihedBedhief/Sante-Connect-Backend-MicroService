...
import tn.microservices.Blog.Services.IServiceComment;
...
public class CommentController {
    ...
    public ResponseEntity<Comment> addComment(@RequestBody Comment commentDto, @RequestParam("postId") Long postId) {
        try {
            Comment addedComment = commentService.addComment(commentDto, postId);
